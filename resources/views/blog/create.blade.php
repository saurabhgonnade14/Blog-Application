              ...
              <form  action="{{route('blog.store')}}" Method="post"enctype ="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <textarea type="text" class="form-control" id="body" name="description" placeholder="description"> </textarea>
                  </div>
                  {{-- <div class="form-group">
...
@endforeach
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-dark">S U B M I T</button>
                </div>
              </form>
            </div>
