  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>BLOGGING FORM EDIT</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">BLOGGING APPLICATION</a></li>
              <li class="breadcrumb-item active">BLOG FORM EDIT</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-6">
            ...
            <div class="card card-danger">
              <div class="card-header">
                <h3 class="card-title">BLOG FORM EDIT</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form  action="{{route('blog.update',$data->id)}}" Method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                          <div class="custom-file">
                            <input type="file" class="custom-file-input" id="exampleInputFile" name="profile_image" value="{{$data->profile_image}}">
                            <label class="custom-file-label" for="exampleInputFile">Choose file</label>
                          </div></div></div><br>
                          <div class="form-group">
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-dark"> U P D A T E</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
