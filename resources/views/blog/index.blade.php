                ...
                <div class="card-tools">
                  ...
                  <div class="col-12..text-right" align="right">
                    <a href="{{route('blog.create')}}">
                      <button type="button"  class="nav-link btn btn-success create-new-button" >ADD BLOG</button>
                    </a>
                  </div>
                </div>
              ...
              <div class="card-body table-responsive p-0">
                ...
                @endphp
                    ...
                    <tr>
                        ...
                        <td>
                            <img src="{{asset('uploads/products/'.$d->profile_image) }}" width="50px" height="50px" alt="Image">
                        </td>
