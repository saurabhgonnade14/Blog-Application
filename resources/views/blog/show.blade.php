            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <article>
                        ...
                        <img class="card-img-top" width="900px" height="400px" src="{{asset('uploads/products/image.jpg')}}" alt="..."/>
                        @else

                        <img class="card-img-top" width="900px" height="400px" src="{{asset('uploads/products/'.$blog->profile_image)}}" alt="..."/>
